...
public:
    Bubble(double cx, double cy, double r, double vx_=BUBBLE_DEFAULT_VX, double vy_=BUBBLE_DEFAULT_VY, Color color_=COLOR(0, 255, 255))
    {
        // Bubble constructor
        color = color_;
    ...
    {
        // move the bubble
        vy = vy + 100*t; //implementing gravity
        ...
        if ((new_y > (450 - circle.getRadius()))) // bounce along Y direction at bottom margin
        {
